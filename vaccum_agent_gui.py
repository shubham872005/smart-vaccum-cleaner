...
import time
import random
from vacuum_agent import Environment, VacuumAgent  # make sure this exists
...
class VacuumGUI:
    def __init__(self, root, rows=5, cols=5):
        ...
        # Images dictionary (placeholder colors)
        self.images = {}
        self.load_images()
    ...
    def load_images(self):
        """Use colored rectangles as placeholders for tiles and vacuum."""
        self.images["vacuum"] = tk.PhotoImage(width=80, height=80)
        self.images["clean"] = tk.PhotoImage(width=80, height=80)
        self.images["dirty"] = tk.PhotoImage(width=80, height=80)
        self.images["obstacle"] = tk.PhotoImage(width=80, height=80)

        # Fill placeholder colors
        self.images["vacuum"].put(("blue",), to=(0,0,79,79))
        self.images["clean"].put(("white",), to=(0,0,79,79))
        self.images["dirty"].put(("brown",), to=(0,0,79,79))
        self.images["obstacle"].put(("black",), to=(0,0,79,79))
